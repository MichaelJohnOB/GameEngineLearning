...
#include "GameEngineLearning/Events/ApplicationEvent.h"
#include "GameEngineLearning/Events/Event.h"
#include "GameEngineLearning/Events/MouseEvent.h"
#include "GameEngineLearning/Events/KeyEvent.h"
...
namespace GameEngineLearning
{
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		if (!s_GLFWInitialized)
		{
			...
			GEL_CORE_ASSERT(success, "Could not initialize GLFW!");
	...
	void WindowsWindow::SetVSync(bool enabled)
	{
		if (enabled)
		{
			//wait for 1 frame to be rendered
			glfwSwapInterval(1);
		}
		else
		{
